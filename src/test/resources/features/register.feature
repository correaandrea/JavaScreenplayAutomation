...
Feature: Funcionalidad de Registro de Usuario
  ...
  Scenario: Registro exitoso de un nuevo usuario
    ...
    And me registro con los datos: "Auxilio", "Dios", "kieroyorar@correo.com", "guacala" y "guacala"
    Then deberia ser redirigido al home y ver mi sesion iniciada con el nombre "Auxilio"